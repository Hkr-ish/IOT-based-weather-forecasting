...
- SQLite (Data Storage)
  ...
  This is an IoT-Based Temperature Forecasting System that simulates temperature data from IoT sensors and uses machine learning to forecast future
  temperatures. The system provides a web interface to visualize real-time and historical temperature data, along with predictions.
